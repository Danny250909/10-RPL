    ...
    <section ref={ref} id="projects" className="py-32 bg-gradient-to-b from-background to-muted/10">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            Menampilkan karya terbaik dengan teknologi modern dan desain terkini / Showcasing my best work with cutting-edge technologies and modern design
          </motion.p>
        </motion.div>
        ...
        >
          {categories.map((category) => (
            ...
            >
              {categoryLabels[category].id} / {categoryLabels[category].en}
            </Button>
          ))}
        </motion.div>
        ...
        >
          <GlassCard className="max-w-md mx-auto p-12">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-4">
              Suka yang Kamu Lihat? / Like What You See?
            </h3>
            <p className="text-muted-foreground mb-8">
              Hubungi saya untuk diskusikan proyek selanjutnya / Get in touch to discuss your next project
            </p>
            <MagneticButton>
              <Button className="neon w-full px-12 py-8 text-lg font-bold">
                Mari Bicara Proyek / Let's Talk Projects
              </Button>
            </MagneticButton>
          </GlassCard>
        </motion.div>
