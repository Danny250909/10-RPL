...
const stats = [
  { value: 30, label: 'Proyek Selesai', labelEn: 'Projects Completed', icon: Code, suffix: '+' },
  { value: 10, label: 'Tugas KELAS', labelEn: 'KELAS Assignments', icon: User, suffix: '+' },
  { value: 1500, label: 'Jam Coding', labelEn: 'Hours of Coding', icon: Code, suffix: '+' },
  { value: 12, label: 'Teknologi', labelEn: 'Technologies', icon: Layers, suffix: '+' }
]
        ...
        >
          ...
          >
            ...
            <span className="text-muted-foreground">
              Kelas: 10 RPL • Hobi: Tidur, Main Game, Belajar
            </span>
          ...
          >
            Membangun pengalaman digital yang rapi dan interaktif dengan kode. / Building clean and interactive digital experiences with code.
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">{stat.labelEn}</p>
            </motion.div>
          ))}
        </motion.div>
            ...
            <Card className="glass border-0 shadow-2xl overflow-hidden hover:shadow-3xl hover:shadow-neon-green/20 transition-all duration-500">
              <CardHeader className="pb-8">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Teknologi yang saya gunakan saat ini / Technologies I'm currently working with
                </p>
              </CardHeader>
          ...
          >
            <Card className="glass border-0 shadow-2xl h-full hover:shadow-3xl hover:shadow-neon-purple/20 transition-all duration-500">
              <CardHeader className="pb-8">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Perjalanan saya dalam membuat kode / My journey in coding
                </p>
              </CardHeader>
                    ...
                    <div className="flex items-start gap-6 group-hover:translate-x-2 transition-all duration-500">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-4 mb-3">
                          {exp.company === 'SMKN 2 Buduran' ? (
                            <>
                              <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold uppercase tracking-wide">
                                {exp.duration}
                              </span>
                              <div>
                                <h4 className="font-black text-xl leading-tight group-hover:text-neon-purple transition-colors">
                                  {exp.company}
                                </h4>
                              </div>
                            </>
                            ...
                            <>
                              ...
                              <div>
                                ...
                                <p className="text-muted-foreground font-semibold text-base leading-tight">
                                  {exp.company}
                                </p>
                              </div>
                            </>
              ...
              <CardFooter className="pt-0 border-t-0">
                <MagneticButton className="w-full">
                  <Button className="w-full bg-gradient-to-r from-neon-green to-neon-blue hover:from-neon-blue hover:to-purple-500 shadow-lg hover:shadow-neon-green/50 font-bold">
                    Lihat CV Lengkap / View Full Resume
                  </Button>
                </MagneticButton>
              </CardFooter>
            </Card>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="text-left md:text-center flex-1">
                <h3 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-neon-green to-primary bg-clip-text text-transparent mb-4 drop-shadow-lg">
                  Siap bekerja sama? / Ready to work together?
                </h3>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Mari buat sesuatu yang luar biasa / Let's create something extraordinary
                </p>
              </div>
